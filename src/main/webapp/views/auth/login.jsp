...
<main class="auth-page"><section class="auth-visual"><div><h1>Chào mừng trở lại</h1><p>Đăng nhập để tiếp tục trải nghiệm UTE EcoMart.</p></div></section>
<section class="auth-panel"><div class="auth-card">
    ...
    <form class="auth-form" method="post" action="${pageContext.request.contextPath}/login">
        <div><label for="login">Tài khoản hoặc email</label><input id="login" name="login" value="${login}" maxlength="255" required autofocus></div>
        <div><label for="password">Mật khẩu</label><input id="password" type="password" name="password" maxlength="255" required></div>
